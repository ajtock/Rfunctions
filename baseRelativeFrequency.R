...
baseRelativeFreq <- function(targets, genome, mask, flankSize, locSize, outDir, targetName) {
  ...
  write.table(a.coords, file = paste0(outDir, targetName, "_target.a.txt"))
  write.table(t.coords, file = paste0(outDir, targetName, "_target.t.txt"))
  write.table(g.coords, file = paste0(outDir, targetName,"_target.g.txt"))
  write.table(c.coords, file = paste0(outDir, targetName, "_target.c.txt"))
